...
//  UltimateScorer
//
//  Created by Richard Chang on 2/18/10.
...
@implementation GameDetailsTableViewController
...
/*    static NSString *cellId = [NSString stringWithFormat:@"%d", indexPath.row];
    ...
    // Set up the cell...
	cell.text = [[gameState detailsArray] objectAtIndex:indexPath.row];
